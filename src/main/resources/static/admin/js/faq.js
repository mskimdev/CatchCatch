            ...
            CcUI.confirm({
                ...
                onConfirm: async () => {
                    try {
                        ...
                        const { res, data } = await apiDelete(`/api/admin/faqs/${id}`);
            ...
            CcUI.confirm({
                ...
                onConfirm: async () => {
                    try {
                        ...
                        const { res, data } = await apiPut(`/api/admin/faqs/${id}`, body);
...
function isEmptySummernote(html) {
    return html === "" || html === "<p><br></p>" || $("<div>").html(html).text().trim() === "";
}