...
VALUES ('고척스카이돔', '서울특별시 구로구 경인로 430', 25000, NULL, NOW()),
       ...
       ('k6 부하테스트 공연장 B', '서울특별시 송파구 올림픽로 001', 1000, '/temp/seatmap/seats/example-seatmap-seats.json', NOW());
...
VALUES (2, 'Red Velvet FAN-CON 〈A Day in Red & Velvet〉', 'Red Velvet',
        ...
        '/images/details/detail-redvelvet.jpg', '레드벨벳과 함께하는 특별한 여름', '고려대학교 화정체육관을 가득 채울 열기와 감동',
       ...
       (4, '뮤지컬 〈베토벤〉', '뮤지컬 배우 앙상블',
        ...
        '/images/details/detail-beethoven.jpg', '천재의 고뇌와 열정이 만들어낸 불멸의 선율', '세종문화회관 대극장을 가득 채울 웅장한 무대',
       ...
       (1, '2027 후지이 카제 Prema 월드 투어 - 서울', '후지이 카제',
        ...
        '/images/details/detail-fujiikaze.jpg', '다시 한번 고척돔을 가득 채울 그의 목소리', '단 하루뿐인 서울 공연, 놓치지 마세요',
       ...
       (5, '워터밤 서울 2026', '다수 아티스트',
        ...
        '/images/details/detail-waterbomb.jpg', '2026년 여름, 가장 뜨거운 3일', '킨텍스를 흠뻑 적실 잊지 못할 여름 추억',
       ...
       (6, '사운드 플래닛 페스티벌 2026', '다수 아티스트',
        ...
        '/images/details/detail-soundplanet.png', '바다와 음악이 만나는 최고의 페스티벌', '인천 파라다이스시티에서 즐기는 낭만적인 음악 축제',
       ...
       (3, 'ICN 〉 NTG : BIG Naughty Concert', 'BIG Naughty (서동현)',
        ...
        '/images/details/detail-bignaughty.png', '힙합을 넘어선 음악적 진화', '장충체육관을 뒤흔들 역대급 퍼포먼스',
       ...
       (3, 'David Byrne Who Is The Sky? Tour', 'David Byrne',
        ...
        '/images/details/detail-davidbyrne.png', '살아있는 전설이 서울을 찾아옵니다', '경희대 평화의전당에서 펼쳐지는 단 하루의 공연',
       ...
       (2, '나상현씨밴드 클럽투어 ''여름빛 2026'' - 서울', '나상현씨밴드',
        ...
        '/images/details/detail-nasanghyun.jpg', '여름밤과 가장 잘 어울리는 인디의 감성', '소규모 공연장에서만 느낄 수 있는 뜨거운 라이브',
       ...
       (4, '정명훈x KBS교향악단x김선욱 〈베토벤+브람스〉', '정명훈, 김선욱',
        ...
        '/images/details/detail-myunghun.jpg', '두 거장이 함께하는 클래식의 밤', '세종문화회관 대극장에서 만나는 베토벤과 브람스의 걸작',
       ...
       (5, '2026 전주얼티밋뮤직페스티벌', '다수 아티스트',
        ...
        '/images/banners/banner-jeonju-festival.jpg', '전주에서 만나는 여름의 절정', '전주 완산야구장을 가득 채울 잊지 못할 여름 추억',
       ...
       (6, '2026 인천 펜타포트 락 페스티벌', '다수 아티스트',
        ...
        '/images/banners/banner-pentaport.png', '인천에서 울려 퍼지는 록의 함성', '송도달빛축제공원에서 즐기는 여름 최고의 록 페스티벌',
...
VALUES (1, '2026-08-01', '18:00:00', '1회차', NOW(), false),   -- session_id 1  (RedVelvet 1일차)
       ...
       (11, '2026-06-24', '10:00:00', '24일 임시', NOW(), false), -- session_id 17 (k6B)
