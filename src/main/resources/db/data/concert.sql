...
VALUES
    (1, '아이유 콘서트 2026 [HEREH]', '아이유', '아이유의 2026년 단독 콘서트. 새 앨범 수록곡을 포함한 화려한 무대.', '/images/sample/poster-music.svg', 'OPEN',
     ...
     '/images/sample/iu_describe.jpg', '여름밤을 수놓을 아름다운 목소리', '아이유와 함께하는 잊지 못할 특별한 시간', '놓칠 수 없는 단 이틀간의 공연',
...
-- 2. 새로운 데이터 삽입 (x, y 좌표 + size, angle 포함)
INSERT INTO seat_tb
...
VALUES
    ...
    (1, 1, 'VIP', 'A', 1, '1층 VIP구역 A열 1번', 'VIP', 165000, 'SOLD', 100, 150, 20, 0, NOW()),
    (1, 1, 'VIP', 'A', 2, '1층 VIP구역 A열 2번', 'VIP', 165000, 'SOLD', 130, 150, 20, 0, NOW()),
    (1, 1, 'VIP', 'A', 3, '1층 VIP구역 A열 3번', 'VIP', 165000, 'HELD', 160, 150, 20, 0, NOW()),
    (1, 1, 'VIP', 'A', 4, '1층 VIP구역 A열 4번', 'VIP', 165000, 'AVAILABLE', 190, 150, 20, 0, NOW()),
    (1, 1, 'VIP', 'A', 5, '1층 VIP구역 A열 5번', 'VIP', 165000, 'AVAILABLE', 220, 150, 20, 0, NOW()),

    -- 아이유 R석 (1층 R구역 B열 1~10번)
    (1, 1, 'R', 'B', 1, '1층 R구역 B열 1번', 'R', 132000, 'SOLD', 70, 190, 20, 0, NOW()),
    (1, 1, 'R', 'B', 2, '1층 R구역 B열 2번', 'R', 132000, 'SOLD', 100, 190, 20, 0, NOW()),
    (1, 1, 'R', 'B', 3, '1층 R구역 B열 3번', 'R', 132000, 'SOLD', 130, 190, 20, 0, NOW()),
    (1, 1, 'R', 'B', 4, '1층 R구역 B열 4번', 'R', 132000, 'AVAILABLE', 160, 190, 20, 0, NOW()),
    (1, 1, 'R', 'B', 5, '1층 R구역 B열 5번', 'R', 132000, 'AVAILABLE', 190, 190, 20, 0, NOW()),
    (1, 1, 'R', 'B', 6, '1층 R구역 B열 6번', 'R', 132000, 'AVAILABLE', 220, 190, 20, 0, NOW()),
    (1, 1, 'R', 'B', 7, '1층 R구역 B열 7번', 'R', 132000, 'AVAILABLE', 250, 190, 20, 0, NOW()),
    (1, 1, 'R', 'B', 8, '1층 R구역 B열 8번', 'R', 132000, 'AVAILABLE', 280, 190, 20, 0, NOW()),
    (1, 1, 'R', 'B', 9, '1층 R구역 B열 9번', 'R', 132000, 'AVAILABLE', 310, 190, 20, 0, NOW()),
    (1, 1, 'R', 'B', 10, '1층 R구역 B열 10번', 'R', 132000, 'AVAILABLE', 340, 190, 20, 0, NOW()),

    -- 아이유 S석 (2층 S구역 A열 1~10번)
    (1, 2, 'S', 'A', 1, '2층 S구역 A열 1번', 'S', 110000, 'SOLD', 70, 250, 20, 0, NOW()),
    (1, 2, 'S', 'A', 2, '2층 S구역 A열 2번', 'S', 110000, 'AVAILABLE', 100, 250, 20, 0, NOW()),
    (1, 2, 'S', 'A', 3, '2층 S구역 A열 3번', 'S', 110000, 'AVAILABLE', 130, 250, 20, 0, NOW()),
    (1, 2, 'S', 'A', 4, '2층 S구역 A열 4번', 'S', 110000, 'AVAILABLE', 160, 250, 20, 0, NOW()),
    (1, 2, 'S', 'A', 5, '2층 S구역 A열 5번', 'S', 110000, 'AVAILABLE', 190, 250, 20, 0, NOW()),
    (1, 2, 'S', 'A', 6, '2층 S구역 A열 6번', 'S', 110000, 'AVAILABLE', 220, 250, 20, 0, NOW()),
    (1, 2, 'S', 'A', 7, '2층 S구역 A열 7번', 'S', 110000, 'AVAILABLE', 250, 250, 20, 0, NOW()),
    (1, 2, 'S', 'A', 8, '2층 S구역 A열 8번', 'S', 110000, 'AVAILABLE', 280, 250, 20, 0, NOW()),
    (1, 2, 'S', 'A', 9, '2층 S구역 A열 9번', 'S', 110000, 'AVAILABLE', 310, 250, 20, 0, NOW()),
    (1, 2, 'S', 'A', 10, '2층 S구역 A열 10번', 'S', 110000, 'AVAILABLE', 340, 250, 20, 0, NOW()),

    -- 아이유 A석 (2층 A구역 B열 1~10번)
    (1, 2, 'A', 'B', 1, '2층 A구역 B열 1번', 'A', 88000, 'AVAILABLE', 70, 290, 20, 0, NOW()),
    (1, 2, 'A', 'B', 2, '2층 A구역 B열 2번', 'A', 88000, 'AVAILABLE', 100, 290, 20, 0, NOW()),
    (1, 2, 'A', 'B', 3, '2층 A구역 B열 3번', 'A', 88000, 'AVAILABLE', 130, 290, 20, 0, NOW()),
    (1, 2, 'A', 'B', 4, '2층 A구역 B열 4번', 'A', 88000, 'AVAILABLE', 160, 290, 20, 0, NOW()),
    (1, 2, 'A', 'B', 5, '2층 A구역 B열 5번', 'A', 88000, 'AVAILABLE', 190, 290, 20, 0, NOW()),
    (1, 2, 'A', 'B', 6, '2층 A구역 B열 6번', 'A', 88000, 'AVAILABLE', 220, 290, 20, 0, NOW()),
    (1, 2, 'A', 'B', 7, '2층 A구역 B열 7번', 'A', 88000, 'AVAILABLE', 250, 290, 20, 0, NOW()),
    (1, 2, 'A', 'B', 8, '2층 A구역 B열 8번', 'A', 88000, 'AVAILABLE', 280, 290, 20, 0, NOW()),
    (1, 2, 'A', 'B', 9, '2층 A구역 B열 9번', 'A', 88000, 'AVAILABLE', 310, 290, 20, 0, NOW()),
    (1, 2, 'A', 'B', 10, '2층 A구역 B열 10번', 'A', 88000, 'AVAILABLE', 340, 290, 20, 0, NOW()),

    -- 뮤지컬 시카고 샘플 좌석
    (3, 1, 'VIP', 'A', 1, '1층 VIP구역 A열 1번', 'VIP', 198000, 'SOLD', 100, 150, 20, 0, NOW()),
    (3, 1, 'VIP', 'A', 2, '1층 VIP구역 A열 2번', 'VIP', 198000, 'AVAILABLE', 130, 150, 20, 0, NOW()),
    (3, 1, 'R', 'B', 1, '1층 R구역 B열 1번', 'R', 165000, 'AVAILABLE', 70, 190, 20, 0, NOW()),
    (3, 2, 'S', 'A', 1, '2층 S구역 A열 1번', 'S', 132000, 'AVAILABLE', 70, 250, 20, 0, NOW()),
    (3, 2, 'A', 'B', 1, '2층 A구역 B열 1번', 'A', 99000, 'AVAILABLE', 70, 290, 20, 0, NOW());