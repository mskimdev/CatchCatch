...
public class QBooking extends EntityPathBase<Booking> {
    ...
    public final com.catchcatch.ticket.booking.bookingSeat.QBookingDetail bookingDetail;
    ...
    public QBooking(Class<? extends Booking> type, PathMetadata metadata, PathInits inits) {
        ...
        this.bookingDetail = inits.isInitialized("bookingDetail") ? new com.catchcatch.ticket.booking.bookingSeat.QBookingDetail(forProperty("bookingDetail"), inits.get("bookingDetail")) : null;
